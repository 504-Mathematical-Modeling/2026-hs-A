...
\section*{附录A\quad 结果文件说明}
\begin{table}[H]\centering\caption{提交目录中的主要文件}\begin{tabular}{p{5cm}p{8cm}}\toprule 文件&用途\\\midrule 01\_代码/solve\_all.py&主求解程序\\ 01\_代码/make\_figures.py&论文图表生成程序\\ 02\_论文/files/summary.json&数值汇总\\ 02\_论文/files/q2\_probability.json&问题二结果\\ 02\_论文/files/q3\_threshold.json&问题三扫描结果\\ 02\_论文/files/q4\_mixture\_search.json&问题四候选结果\\ 02\_论文/figures/*.pdf&论文图表\\\bottomrule\end{tabular}\end{table}
